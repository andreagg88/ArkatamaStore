                        ...
                        <?php if ($value['status_produk'] == 'disetujui') { ?>
                            <div class="card mt-4 portfolio portfolio-wrap" style="width: 265px; margin: 0 auto;">
                                ...
                                <div class="card-body">
                                    ...
                                    <small style="font-size: 12px;"><?= $value['keterangan_barang']; ?></small><br>
                                    ...
                                    <a href="<?= base_url('user/detail_produk/' . $value['id_barang']); ?>" class="btn btn-warning text-white btn-sm">Details</a>
                                </div>
                            </div>
                        <?php } ?>
                    <?php endforeach; ?>
