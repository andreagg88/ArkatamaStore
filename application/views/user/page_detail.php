                        ...
                        <div class="col-lg-6">
                            <div class="portfolio-info">
                                ...
                                <ul>
                                    ...
                                    <li><strong>Harga</strong>: <?= number_format($value->harga_barang, 0, ',', '.');  ?></li>
                                    <li><strong>Stok</strong>: <?= $value->stok_barang; ?></li>
                                    <li><strong>Kondisi</strong>: <?= $value->kondisi_barang; ?></li><br>
                                    <li> <a href="<?= base_url('user/page_produk'); ?>" class="btn btn-danger ">Kembali</a> <a href="https://wa.me/6285764441284" class="btn btn-primary ">Pesan Sekarang</a></li>
